...
<p align="center">
  ...
  <a href="docs/decisions.md">Decision log (RU)</a> ·
  <a href="docs/architecture.md">Architecture (RU)</a> ·
  <a href="docs/performance.md">Measurements (RU)</a> ·
  <a href="docs/roadmap.md">Roadmap (RU)</a>
</p>
...
The long version, with the alternatives I weighed for each, is in [docs/decisions.md](docs/decisions.md) (Russian).
...
The numbers reproduce: `node tools/measure.js` starts a static server and drives Chromium over it. Method and full output in [docs/performance.md](docs/performance.md) (Russian).
